...
Critter::Critter(){
    ...
    cout << endl << "using first constructor" << endl << endl;
}
...
Critter::Critter(string newname){
    ...
    cout << endl << "using second constructor" << endl << endl;
}
...
Critter::Critter(string newname, int newboredom, int newhunger, double newheight) {
    ...
    cout << endl << "using third constructor" << endl << endl;
}

// fourth constructor definition
Critter::Critter(string newname, int newboredom, int newhunger, double newheight, double newthirst){
    name = newname;
    boredom = newboredom;
    hunger = newhunger;
    height = newheight;
    thirst = newthirst;
    cout << endl << "using fourth constructor " << endl << endl;
}
// name setter
